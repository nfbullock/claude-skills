...
```bash
~/venv/default/bin/python /Users/dad/Documents/sandbox/backstairs/things/things.py add \
...
```
~/venv/default/bin/python /Users/dad/Documents/sandbox/backstairs/things/things.py <cmd>
```
