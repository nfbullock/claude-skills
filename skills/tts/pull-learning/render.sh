...
#   LOCAL  artifacts/.tts/pull-learning/<chapter>.wav            (master)
#          artifacts/.tts/pull-learning/<chapter>_turns/...wav   (per-turn cache)
...
LOCAL_DIR="$HOME/Documents/sandbox/artifacts/.tts/pull-learning"
